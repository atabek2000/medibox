...
<template>
  <div class="starred_button z-10 cursor-pointer" @click="addToFav">
    <img
      v-if="is_fav"
      src="~assets/svg/common/heart-red-starred-product.svg"
      alt="heart"
    />
    <img
      v-else
      src="~assets/svg/common/heart-gray-starred-product.svg"
      alt="heart"
    />
  </div>
</template>
