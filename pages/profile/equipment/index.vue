...
const {
  ...
  () =>
    $fetch(useRuntimeConfig().public.API_URL + `equipments`, {
      headers: {
    ...
    <div class="flex justify-between items-center">
      <CommonUiBreadCrumb
        ...
        :links="[
          ...
          { label: $t('bread_crumb.my_equipments') },
        ]"
      />
    ...
    <div class="flex gap-x-6">
      ...
      <div class="w-full">
        ...
        >
          ...
          >
            <ProfileEquipmentCard :equipment="equipment" />
          </div>
          ...
          <UButton
            ...
            >{{ $t("button.add_equipment") }}</UButton
          >
        </div>
        <div
          v-else-if="pending"
